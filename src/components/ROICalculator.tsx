  ...
  return (
    <div className="glass-panel rounded-3xl p-6 md:p-8 border border-white/10 shadow-lg select-none" id="roi-calculator-widget">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 pb-6 border-b border-white/10">
        ...
        <button
          onClick={handleReset}
          className="flex items-center gap-1.5 text-xs text-white/60 hover:text-white transition-colors px-3 py-1.5 rounded-none border border-white/10 bg-white/5"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center text-sm">
              <label className="font-medium text-white/80 flex items-center gap-1.5">
                Quanto vorresti investire ogni mese in pubblicità?
              </label>
              <span className="font-mono font-bold text-white bg-white/10 px-2.5 py-1 rounded-md shadow-sm border border-white/10">
        ...
        <div className="lg:col-span-5 flex flex-col justify-between gap-6">
          <div className="bg-white/10 backdrop-blur-md text-white rounded-2xl p-6 flex flex-col gap-5 shadow-inner border border-white/10">
            <div className="flex justify-between items-center">
              <span className="text-xs uppercase tracking-widest text-white/60 font-semibold">Risultati Stimati</span>
            ...
            <div className="grid grid-cols-2 gap-4 border-b border-white/10 pb-4">
              <div>
                <p className="text-[10px] text-white/40 uppercase">Click Mensili</p>
                <p className="font-display text-lg font-bold font-mono text-white mt-1">{estimatedClicks}</p>
              </div>
              <div>
                <p className="text-[10px] text-white/40 uppercase">Contatti (Lead)</p>
            ...
            <div className="grid grid-cols-2 gap-4 border-b border-white/10 pb-4">
              <div>
                <p className="text-[10px] text-white/40 uppercase">Nuovi Clienti Chiusi</p>
                <p className="font-display text-lg font-bold font-mono text-accent-orange mt-1">~{estimatedCustomers}</p>
              </div>
              <div>
                <p className="text-[10px] text-white/40 uppercase">Valore ROI Stimato</p>
            ...
            <div className="pt-2">
              <p className="text-[10px] text-white/40 uppercase">Possibile Incasso Mensile</p>
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-4 items-center justify-between p-4 bg-white/5 rounded-none border border-white/10 text-xs">
        <span className="text-white/40 text-left">
          * Nota: questi calcoli sono stime basate su medie di mercato. I risultati reali dipendono dal tuo settore e dalla tua zona.
        </span>
        <a 
          href="#contatti"
          className="bg-white text-charcoal hover:bg-white/90 transition-all px-4 py-2.5 rounded-none font-bold text-center w-full sm:w-auto shrink-0 uppercase tracking-widest text-[10px]"
        >
